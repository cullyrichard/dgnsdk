...
struct instruct insts[] = {
    ...
    { "PSHA", 4, DGN_CTA, 0b0110001100000001, CPU_NOVA4 | CPU_ECLIPSE | CPU_NOVA3 | CPU_F9445, 3 },
    { "PSHN", 4, DGN_CTA, 0b0110001111000001, CPU_NOVA4 | CPU_ECLIPSE | CPU_NOEMU, 0 }, // [Undocumented] PSHA With I/O Pulse
    { "POPA", 4, DGN_CTA, 0b0110001110000001, CPU_NOVA4 | CPU_ECLIPSE | CPU_NOVA3 | CPU_F9445, 4 },
    { "SAV",  3, DGN_CT,  0b0110010100000001, CPU_NOVA4 | CPU_ECLIPSE | CPU_NOVA3 | CPU_F9445, 5 },
    { "SAVN", 4, DGN_CT,  0b0110010111000001, CPU_NOVA4 | CPU_ECLIPSE | CPU_NOEMU, 0 }, // [Undocumented] SAV with I/O Pulse
    { "RET",  3, DGN_CT,  0b0110010110000001, CPU_NOVA4 | CPU_ECLIPSE | CPU_NOVA3 | CPU_F9445, 6 },
    { "MTSP", 4, DGN_CTA, 0b0110001000000001, CPU_NOVA4 | CPU_ECLIPSE | CPU_NOVA3 | CPU_F9445, 7 },
    { "MTFP", 4, DGN_CTA, 0b0110000000000001, CPU_NOVA4 | CPU_ECLIPSE | CPU_NOVA3 | CPU_F9445, 8 },
    { "MFSP", 4, DGN_CTA, 0b0110001010000001, CPU_NOVA4 | CPU_ECLIPSE | CPU_NOVA3 | CPU_F9445, 9 },
    { "MFFP", 4, DGN_CTA, 0b0110000010000001, CPU_NOVA4 | CPU_ECLIPSE | CPU_NOVA3 | CPU_F9445, 10 },
    ...
    { "MUL",  3, DGN_CT, 0b0111011011000001, CPU_MDV | CPU_NOVA3 | CPU_NOVA4 | CPU_ECLIPSE | CPU_F9445, 1 },
    { "MULS", 4, DGN_CT, 0b0111111010000001, CPU_NOVA4 | CPU_ECLIPSE | CPU_F9445, 13 },
    { "DIV",  3, DGN_CT, 0b0111011001000001, CPU_MDV | CPU_NOVA3 | CPU_NOVA4 | CPU_ECLIPSE | CPU_F9445, 2 },
    { "DIVS", 4, DGN_CT, 0b0111111000000001, CPU_NOVA4 | CPU_ECLIPSE | CPU_F9445, 14 },
    ...
    { "AP0", 3, DGN_HWID, 054, CPU_BASE, 0 }, // FPS100 AP0
    { "AP1", 3, DGN_HWID, 055, CPU_BASE, 0 },
    { "AP2", 3, DGB_HWID, 056, CPU_BASE, 0 }
};
